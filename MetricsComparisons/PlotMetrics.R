...
# Check column names and unique analyses
glimpse(df)
analyses <- unique(df$Analysis)

# Plot C vs S, colored by Analysis
ggplot(df, aes(x = S, y = C, color = Analysis)) +
  geom_point(size = 2) +
  theme_classic() +
...
ggplot(df, aes(x = S, y = L_D, color = Analysis)) +
  geom_point(size = 2) +
  theme_classic() +
...
ggplot(df, aes(x = S, y = Mean_NTP, color = Analysis)) +
  geom_point(size = 2) +
  theme_classic() +
...
ggplot(df, aes(x = S, y = Max_NTP, color = Analysis)) +
  geom_point(size = 2) +
  theme_classic() +
...
# incoherence (q) vs S
ggplot(df, aes(x = S, y = q_inCoherence, color = Analysis)) +
  geom_point(size = 2) +
  theme_classic() +
...
ggplot(df, aes(x = S, y = Mean_longest_chain, color = Analysis)) +
  geom_point(size = 2) +
  theme_classic() +
...
ggplot(df, aes(x = S, y = Mean_path_len, color = Analysis)) +
  geom_point(size = 2) +
  theme_classic() +
...
# % apex taxa vs S
ggplot(df, aes(x = S, y = Top, color = Analysis)) +
  geom_point(size = 2) +
  theme_classic() +
...
# t-test on connectance
t.test(C ~ lumped, data = rhynie_df)

# Example: t-test on mean trophic level
t.test(mean_NTP ~ group, data = modern_vs_rhynie)
